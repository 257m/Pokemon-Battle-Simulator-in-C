...
void ExecuteMove(bool eop) {
    if (!Parties[eop].Dead) {
        ...
        MOVE_FUNC_LIST[MoveList[Parties[eop].Turn->Move].movefunc >> 5](3,eop);
        display_move(eop);
      if (Parties[eop].Member[0]->CurrentHp > 0 && Parties[eop].Hit && Parties[eop].CanMove) {
        ...
        ABILITY_FUNC_LIST[AbilityList[Parties[!eop].Member[0]->Ability].abilityfunc](-4,!eop);
         MOVE_FUNC_LIST[MoveList[Parties[eop].Turn->Move].movefunc >> 5](1,eop);
         MOVE_FUNC_LIST[MoveList[Parties[eop].Turn->Move].movefunc & REMOVE_FIRST_FIVE_BITS](1,eop);
         ITEM_FUNC_LIST[ItemList[Parties[eop].Member[0]->Item].itemfunc](1,eop);
         ITEM_FUNC_LIST[ItemList[Parties[!eop].Member[0]->Item].itemfunc](-1,!eop);
         Parties[eop].Turn->PP--;
         move_result(eop);
         MOVE_FUNC_LIST[MoveList[Parties[eop].Turn->Move].movefunc >> 5](2,eop);
        MOVE_FUNC_LIST[MoveList[Parties[eop].Turn->Move].movefunc & REMOVE_FIRST_FIVE_BITS](2,eop);
          }
