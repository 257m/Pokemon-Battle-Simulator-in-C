...
void ExecuteMove(bool eop) {
  if (!eop) {
    if (PlayerDead == 0) {
        if (PlayerSwitch == 0) {
        PlayerHit = (map2(rand(),100,RAND_MAX) < (MoveList[YourTurn->Move].Accuracy*statboostmult(Parties[0].Member[0]->StatBoosts[5] / statboostmult(Parties[1].Member[0]->StatBoosts[6]))));
        ...
        else if (Parties[0].Member[0]->Non_Volatile_Status == 1 && MoveList[YourTurn->Move].Category == 1) PlayerTM /= 2;
      ...
      if (Parties[0].Member[0]->CurrentHp > 0 && PlayerHit == 1 && PlayerCanMove == 1) {
        ...
        Damage = (((((2 * Parties[0].Member[0]->Level / 5 + 2) * (Parties[0].Member[0]->Atk*tt(PlayerCrit && (Parties[0].Member[0]->StatBoosts[0] < 0),1,statboostmult(Parties[0].Member[0]->StatBoosts[0]))) * MoveList[YourTurn->Move].BP / (Parties[1].Member[0]->Def*tt(PlayerCrit && (Parties[1].Member[0]->StatBoosts[1] > 0),1,statboostmult(Parties[1].Member[0]->StatBoosts[1])))) / 50) + 2) * STAB * (TypeChart[MoveList[YourTurn->Move].Type][Parties[1].Member[0]->Poke->Type1] * TypeChart[MoveList[YourTurn->Move].Type][Parties[1].Member[0]->Poke->Type2]) * ((rand() % 16) + 85) / 100) * PlayerTM * tt(PlayerCrit,1.5,1);
        MoveList[YourTurn->Move].movefunc(1,0);
        ItemList[Parties[0].Member[0]->Item].itemfunc(1,0);
        ItemList[Parties[1].Member[0]->Item].itemfunc(-1,1);
        DBOG(0);
        ...
        Damage = (((((2 * Parties[0].Member[0]->Level / 5 + 2) * (Parties[0].Member[0]->SpA*tt(PlayerCrit && (Parties[0].Member[0]->StatBoosts[2] < 0),1,statboostmult(Parties[0].Member[0]->StatBoosts[2]))) * MoveList[YourTurn->Move].BP / (Parties[1].Member[0]->SpD*tt(PlayerCrit && (Parties[1].Member[0]->StatBoosts[3] > 0),1,statboostmult(Parties[1].Member[0]->StatBoosts[3])))) / 50) + 2) * STAB * TypeChart[MoveList[YourTurn->Move].Type][Parties[1].Member[0]->Poke->Type1] * TypeChart[MoveList[YourTurn->Move].Type][Parties[1].Member[0]->Poke->Type2] * ((rand() % 16) + 85) / 100) * PlayerTM * tt(PlayerCrit,1.5,1);
        MoveList[YourTurn->Move].movefunc(1,0);
        ItemList[Parties[0].Member[0]->Item].itemfunc(1,0);
        ItemList[Parties[1].Member[0]->Item].itemfunc(-1,1);
        DBOG(0);
    ...
    if (EnemyDead == 0) {
        if (EnemySwitch == 0) {
        EnemyHit = (map2(rand(),100,RAND_MAX) < (MoveList[EnemyTurn->Move].Accuracy*statboostmult(Parties[1].Member[0]->StatBoosts[5] / statboostmult(Parties[0].Member[0]->StatBoosts[6]))));
        ...
        else if (Parties[1].Member[0]->Non_Volatile_Status == 1 && MoveList[EnemyTurn->Move].Category == 1) EnemyTM /= 2; 
        ...
        EnemyDamage = (((((2 * Parties[1].Member[0]->Level / 5 + 2) * (Parties[1].Member[0]->Atk*tt(EnemyCrit && (Parties[1].Member[0]->StatBoosts[0] < 0),1,statboostmult(Parties[1].Member[0]->StatBoosts[0]))) * MoveList[EnemyTurn->Move].BP / (Parties[0].Member[0]->Def*tt(EnemyCrit && (Parties[0].Member[0]->StatBoosts[1] > 0),1,statboostmult(Parties[0].Member[0]->StatBoosts[1])))) / 50) + 2) * EnemySTAB * TypeChart[MoveList[EnemyTurn->Move].Type][Parties[0].Member[0]->Poke->Type1] * TypeChart[MoveList[EnemyTurn->Move].Type][Parties[0].Member[0]->Poke->Type2] * ((rand() % 16) + 85) / 100) * EnemyTM * tt(EnemyCrit,1.5,1);
        MoveList[EnemyTurn->Move].movefunc(1,1);
        ItemList[Parties[1].Member[0]->Item].itemfunc(1,1);
        ItemList[Parties[0].Member[0]->Item].itemfunc(-1,0);
        DBOG(1);
        ...
        EnemyDamage = (((((2 * Parties[1].Member[0]->Level / 5 + 2) * (Parties[1].Member[0]->SpA*tt(EnemyCrit && (Parties[1].Member[0]->StatBoosts[2] < 0),1,statboostmult(Parties[1].Member[0]->StatBoosts[2]))) * MoveList[EnemyTurn->Move].BP / (Parties[0].Member[0]->SpD*tt(EnemyCrit && (Parties[0].Member[0]->StatBoosts[3] > 0),1,statboostmult(Parties[0].Member[0]->StatBoosts[3])))) / 50) + 2) * EnemySTAB * TypeChart[MoveList[EnemyTurn->Move].Type][Parties[0].Member[0]->Poke->Type1] * TypeChart[MoveList[EnemyTurn->Move].Type][Parties[0].Member[0]->Poke->Type2] * ((rand() % 16) + 85) / 100) * EnemyTM * tt(EnemyCrit,1.5,1);
        MoveList[EnemyTurn->Move].movefunc(1,1);
        ItemList[Parties[1].Member[0]->Item].itemfunc(1,1);
        ItemList[Parties[0].Member[0]->Item].itemfunc(-1,0);
        DBOG(1);
