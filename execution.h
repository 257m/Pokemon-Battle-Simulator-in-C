void ExecuteMove(bool eop) {
  if (!eop) {
    if (PlayerDead == 0) {
        if (PlayerSwitch == 0) {
        PlayerHit = (map2(rand(),100,RAND_MAX) < (MoveList[YourTurn->Move].Accuracy*statboostmult(PlayerParty.P1->StatBoosts[5] / statboostmult(EnemyParty.P1->StatBoosts[6]))));
        ...
        else if (PlayerParty.P1->Non_Volatile_Status == 1 && MoveList[YourTurn->Move].Category == 1) PlayerTM /= 2;
      ...
      if (PlayerParty.P1->CurrentHp > 0 && PlayerHit == 1 && PlayerCanMove == 1) {
        ...
        Damage = (((((2 * PlayerParty.P1->Level / 5 + 2) * (PlayerParty.P1->Atk*tt(PlayerCrit && (PlayerParty.P1->StatBoosts[0] < 0),1,statboostmult(PlayerParty.P1->StatBoosts[0]))) * MoveList[YourTurn->Move].BP / (EnemyParty.P1->Def*tt(PlayerCrit && (EnemyParty.P1->StatBoosts[1] > 0),1,statboostmult(EnemyParty.P1->StatBoosts[1])))) / 50) + 2) * STAB * (TypeChart[MoveList[YourTurn->Move].Type][EnemyParty.P1->Poke->Type1] * TypeChart[MoveList[YourTurn->Move].Type][EnemyParty.P1->Poke->Type2]) * ((rand() % 16) + 85) / 100) * PlayerTM * tt(PlayerCrit,1.5,1);
        MoveList[YourTurn->Move].movefunc(1,0);
        ItemList[PlayerParty.P1->Item].itemfunc(1,0);
        ItemList[EnemyParty.P1->Item].itemfunc(-1,1);
        ...
        Damage = (((((2 * PlayerParty.P1->Level / 5 + 2) * (PlayerParty.P1->SpA*tt(PlayerCrit && (PlayerParty.P1->StatBoosts[2] < 0),1,statboostmult(PlayerParty.P1->StatBoosts[2]))) * MoveList[YourTurn->Move].BP / (EnemyParty.P1->SpD*tt(PlayerCrit && (EnemyParty.P1->StatBoosts[3] > 0),1,statboostmult(EnemyParty.P1->StatBoosts[3])))) / 50) + 2) * STAB * TypeChart[MoveList[YourTurn->Move].Type][EnemyParty.P1->Poke->Type1] * TypeChart[MoveList[YourTurn->Move].Type][EnemyParty.P1->Poke->Type2] * ((rand() % 16) + 85) / 100) * PlayerTM * tt(PlayerCrit,1.5,1);
        MoveList[YourTurn->Move].movefunc(1,0);
        ItemList[PlayerParty.P1->Item].itemfunc(1,0);
        ItemList[EnemyParty.P1->Item].itemfunc(-1,1);
        EnemyParty.P1->CurrentHp = EnemyParty.P1->CurrentHp - Damage; 
    ...
    if (EnemyDead == 0) {
        if (EnemySwitch == 0) {
        EnemyHit = (map2(rand(),100,RAND_MAX) < (MoveList[EnemyTurn->Move].Accuracy*statboostmult(EnemyParty.P1->StatBoosts[5] / statboostmult(PlayerParty.P1->StatBoosts[6]))));
        ...
        else if (EnemyParty.P1->Non_Volatile_Status == 1 && MoveList[EnemyTurn->Move].Category == 1) EnemyTM /= 2; 
        ...
        EnemyDamage = (((((2 * EnemyParty.P1->Level / 5 + 2) * (EnemyParty.P1->Atk*tt(EnemyCrit && (EnemyParty.P1->StatBoosts[0] < 0),1,statboostmult(EnemyParty.P1->StatBoosts[0]))) * MoveList[EnemyTurn->Move].BP / (PlayerParty.P1->Def*tt(EnemyCrit && (PlayerParty.P1->StatBoosts[1] > 0),1,statboostmult(PlayerParty.P1->StatBoosts[1])))) / 50) + 2) * EnemySTAB * TypeChart[MoveList[EnemyTurn->Move].Type][PlayerParty.P1->Poke->Type1] * TypeChart[MoveList[EnemyTurn->Move].Type][PlayerParty.P1->Poke->Type2] * ((rand() % 16) + 85) / 100) * EnemyTM * tt(EnemyCrit,1.5,1);
        MoveList[EnemyTurn->Move].movefunc(1,1);
        ItemList[EnemyParty.P1->Item].itemfunc(1,1);
        ItemList[PlayerParty.P1->Item].itemfunc(-1,0);
        ...
        EnemyDamage = (((((2 * EnemyParty.P1->Level / 5 + 2) * (EnemyParty.P1->SpA*tt(EnemyCrit && (EnemyParty.P1->StatBoosts[2] < 0),1,statboostmult(EnemyParty.P1->StatBoosts[2]))) * MoveList[EnemyTurn->Move].BP / (PlayerParty.P1->SpD*tt(EnemyCrit && (PlayerParty.P1->StatBoosts[3] > 0),1,statboostmult(PlayerParty.P1->StatBoosts[3])))) / 50) + 2) * EnemySTAB * TypeChart[MoveList[EnemyTurn->Move].Type][PlayerParty.P1->Poke->Type1] * TypeChart[MoveList[EnemyTurn->Move].Type][PlayerParty.P1->Poke->Type2] * ((rand() % 16) + 85) / 100) * EnemyTM * tt(EnemyCrit,1.5,1);
        MoveList[EnemyTurn->Move].movefunc(1,1);
        ItemList[EnemyParty.P1->Item].itemfunc(1,1);
        ItemList[PlayerParty.P1->Item].itemfunc(-1,0);
        PlayerParty.P1->CurrentHp = PlayerParty.P1->CurrentHp - EnemyDamage;
