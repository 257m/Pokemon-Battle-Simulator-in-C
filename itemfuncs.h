...
void Focus_Sashf(char et,bool eop) {
  if (!eop) {
    if (Parties[0].Member[0]->ItemUsable) {
    if (et == -1) {
    if (Parties[0].Member[0]->CurrentHp == Parties[0].Member[0]->Hp && EnemyDamage >= Parties[0].Member[0]->Hp) {
      EnemyDamage = Parties[0].Member[0]->Hp-1;
    ...
    if (Parties[1].Member[0]->ItemUsable) {
    if (et == -1) {
    if (Parties[1].Member[0]->CurrentHp == Parties[1].Member[0]->Hp && Damage >= Parties[1].Member[0]->Hp) {
        Damage = Parties[1].Member[0]->Hp-1;
