...
{{233,103,210,128},50,101,0,NOTYPE,1,0,MF_Struggle << 5,{0,0,0,0,0},FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED},
...
{{155,131},40,95,8,SOUND,SPECIAL,0,FLAG_PROTECT_AFFECTED | FLAG_TYPE_IMMUNITY_AFFECTED}
};
