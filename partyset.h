...
{&Quick_Attack,0,1.6},{&Thunder_Wave,0,1.6},{&Vine_Whip,0,1.6},{&Ember,0,1.6},
0,180,92,4,0,236};

struct MyPokemon EnemyPokemon2 = {&Pidgey,5,20,&Naive,31,31,31,31,31,31,
{&Quick_Attack,0,1.6},{&Thunder_Wave,0,1.6},{&Super_Attack,0,1.6},{&Gust,0,1.6},
0,236,36,4,0,228};

struct MyPokemon EnemyPokemon3 = {&Bulbasaur,5,22,&Impish,31,31,31,31,31,31,
{&Quick_Attack,0,1.6},{&Thunder_Wave,0,1.6},{&Super_Attack,0,1.6},{&Vine_Whip,0,1.6}
,76,44,204,156,0,0};
